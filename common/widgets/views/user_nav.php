<div class="col-lg-3">
	<div class="list-group">
		<div class="list-group">
			...
			<a href="/user/notice"  class="list-group-item"><span class="badge"><?=Yii::$app->params['n_count']?></span>我的提醒</a>
			<a href="/user/message" class="list-group-item"><span class="badge"><?=Yii::$app->params['l_count']?></span>我的私信</a>
